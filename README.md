...
- Press A on the main menu screen, and it will take you to the battle screen which is where the game takes place.
- Your (bottom Pokemon) aim is to defeat the opponent's Pokemon (top bulbasaur) by using attacking moves.
- To pick a move to use, press A on the "Fight" button, and select a move.
